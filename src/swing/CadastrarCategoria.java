...
public class CadastrarCategoria extends javax.swing.JFrame {
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(this, "Você está saindo sem cadastrar a nova categoria! \n "
                + "Deseja realmente sair?", "Sair - Sistema Biblioteca!", WIDTH, 3) == 0) {
            this.dispose();
        }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try {
            ...
            if (!txtNome.getText().isEmpty()) {
                catRN.salvar(cat);
                JOptionPane.showMessageDialog(this, "Nova Categoria incluída com sucesso!", "Cadastro Categoria - Sistema Biblioteca", JOptionPane.INFORMATION_MESSAGE);
            }
