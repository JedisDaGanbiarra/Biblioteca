...
public class Devolucao extends javax.swing.JInternalFrame {
    ...
    private void btnPesqEmprestimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesqEmprestimoActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Ops, Metodo do Botão não criado!", "Devolução de Emprestimos - Sistema Biblioteca", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void txtDevolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDevolverActionPerformed
        ...
        try {
            ...
            if (!txtPesqEmprestimo.getText().isEmpty()) {
                empRN.devolucao(emp);
                JOptionPane.showMessageDialog(this, "Devolução efetuada com sucesso!", "Devolução de Emprestimos - Sistema Biblioteca", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();                
            }            
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Devolução não efetuada!"
                    + "\nPor favor, insira o id do empréstimo.", "Erro - Sistema Biblioteca", JOptionPane.ERROR_MESSAGE);
        }
